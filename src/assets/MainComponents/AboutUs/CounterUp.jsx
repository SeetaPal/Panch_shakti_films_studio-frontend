        ...
        <div className="row container pb-5">
            ...
            <div className="col-12 col-md-6 col-lg-3 py-3 py-lg-5">
                <div className="p-3 py-lg-4 border-golden text-center mx-auto d-flex align-items-center" style={{ flexDirection: "column" }}>
                    <img src="Assets/Images/ProjectDone.png" className="text-center" alt="" />
            ...
            <div className="col-12 col-md-6 col-lg-3 py-3 py-lg-5">
                <div className="p-3 py-lg-4 border-golden text-center mx-auto d-flex align-items-center" style={{ flexDirection: "column" }}>
                    <img src="Assets/Images/TrustedClient.png" className="text-center" alt="" />
            ...
            <div className="col-12 col-md-6 col-lg-3 py-3 py-lg-5">
                <div className="p-3 py-lg-4 border-golden text-center mx-auto d-flex align-items-center" style={{ flexDirection: "column" }}>
                    <img src="Assets/Images/HappyCustomer.png" className="text-center" alt="" />
            ...
            <div className="col-12 col-md-6 col-lg-3 py-3 py-lg-5">
                <div className="p-3 py-lg-4 border-golden text-center mx-auto d-flex align-items-center" style={{ flexDirection: "column" }}>
                    <img src="Assets/Images/CustomerSupport.png" className="text-center" alt="" />
