                        ...
                        <OwlCarousel className="owl-theme " {...options}>
                            <div className="work-item">
                                <div className="work-item-inner ">
                                    ...
                                    <div className="work-image-wrapper">
                                        <img src="publicpublicAssets/images/product.webp" alt="Product Ad Shoot" />
                                    </div>
                                </div>
                            </div>
                            <div className="work-item">
                                <div className="work-item-inner">
                                    ...
                                    <div className="work-image-wrapper">
                                        <img src="publicpublicAssets/images/castingModelling.webp" alt="Casting & Modelling Platform" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="work-item">
                                <div className="work-item-inner">
                                    ...
                                    <div className="work-image-wrapper">
                                        <img src="publicpublicAssets/images/webDev.webp" alt="Voice Over" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="work-item">
                                <div className="work-item-inner">
                                    ...
                                    <div className="work-image-wrapper">
                                        <img src="publicAssets/images/mps.webp" alt="Model Photoshoot" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="work-item">
                                <div className="work-item-inner">
                                    ...
                                    <div className="work-image-wrapper">
                                        <img src="publicAssets/images/voice.webp" alt="Voice Over" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="work-item">
                                <div className="work-item-inner">
                                    ...
                                    <div className="work-image-wrapper">
                                        <img src="publicAssets/images/MusicAlbums.webp" alt="Music Albums Shoot" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="work-item">
                                <div className="work-item-inner">
                                    ...
                                    <div className="work-image-wrapper">
                                        <img src="publicAssets/images/socialMedia.webp" alt="Social Media & Digital Marketing" />
                                    </div>
                                </div>
                            </div>
