    ...
    const cardData = [
        {
            ...
            CompanyLogo: "publicAssets/images/dharmaProducts.webp",
           ...
           // ReadMoreBtn: "Read More"o90u8byutrd
        // path: "/CastingCalls"
        },
    ]
    return (
            ...
            <div className="animate-slide-down  w-100 mt-2">
                <div className="row bg-transparent p-3 shadow  main_contain_height rounded_border" >
                    ...
                    <div className="col-12 Project_Details">
                        ...
                        {/* Header */}
                        <h4 className="mb-3 actives">Actor / Model Dashboard </h4>
                        ...
                        {cardData.map((item) => (
                            <div className="casting-card Footer-bg p-4 mb-5 mt-5">
                                <div className="row" key={item.id}>
                                    ...
                                    <div className="col-md-4 border-start1 d-flex flex-column  p-lg-5">
                                        <div>
