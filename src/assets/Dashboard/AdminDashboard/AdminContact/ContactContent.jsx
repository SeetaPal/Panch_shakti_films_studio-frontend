                ...
                <div style={{ overflowX: 'scroll' }}>
                    <table className="table table-striped w-100">
                        ...
                        <tr>
                            <td>1</td>
                            <td>ABCD</td>
                            <td>+91 456 456 78945</td>
                            <td>abcd@gmail.com</td>
                            <td>Demo</td>
                            <td>   <button className="py-0 btn_height_table  text-white fw-lighter mx-1 bg-success border border-success mt-1"><i className="fa-solid fa-pen-to-square"></i> Edit</button>
